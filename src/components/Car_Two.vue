      ...
      <div class="two_bg">
        ...
        <table border="0" class="peo_tab" style="width:1110px;" cellspacing="0" cellpadding="0" >
          <tr>
            ...
            <td width="395">{{mydata.name}}</td>
            <td class="p_td" width="160">电子邮件</td>
            <td width="395">{{mydata.email}}</td>
          </tr>
          <tr>
        ...
        <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
          ...
          <tr height="70">
            <td align="right" @click="abc()"><a href="#" ><img src="../assets/images/btn_sure.gif" /></a></td>
          </tr>
        </table>
      </div>
    </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            var _this=this
            axios.post(this.url+'/auth/car_one',{
              id:this.$route.query.spid,
              token: localStorage.getItem("token")
            })
              .then(res => {
              this.res=res.data
            });
            axios.post(this.url+'/auth/car_two',{
                token: localStorage.getItem("token")
            })
                .then(mydata => {
                    this.mydata=mydata.data[0]
                });
        },
        methods:{
            abc () {
                axios.post(this.url+'/auth/add',{
                    ...
                    .then(myres=>{
                        ...
                        location.href="http://localhost/laravel/blog/public/api/pay/index?token="+token+"&oid="+myres.data
