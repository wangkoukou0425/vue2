  ...
  <div class="i_bg">
    ...
    <div class="content mar_20">
      <table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
        <tr>
          <td class="car_th" width="490">选择商品</td>
        ...
        <tr v-for="(value,key) in catr" align="center" >
          <td><input type="checkbox" class="input" v-bind:value="value.id" v-on:click="checkboxa()" name="bb"></td>
          <td align="center">
            <div class="c_s_img"><img src="../assets/images/c_1.jpg" width="73" height="73" /></div>
            <div align="center">{{value.goods_name}}</div>
          </td>
          <td align="center">{{value.attr_name}}</td>
          <td align="center">
            <div class="c_num">
              <input type="button" value="-" v-on:click="greed(value.number -=1,value.id);" class="car_btn_1" />
              <input type="text" v-bind:value="value.number"
                     class="car_ipt" />
              <input type="button" value="+" v-on:click="greed(value.number +=1,value.id);" class="car_btn_2" />
            </div>
          </td>
          <td align="center" style="color:#ff4e00;">￥{{value.price}}</td>
          <td align="center">￥{{value.number * value.price}}</td>
        ...
        <tr height="70">
          <td colspan="6" style="font-family:'Microsoft YaHei'; border-bottom:0;">
            ...
            <span class="fr">商品总价：<b style="font-size:22px; color:#ff4e00;">￥{{all_price}}</b></span>
          </td>
        <tr valign="top" height="150">
          <td colspan="6" align="right">
            <!--            <router-link to="/cart_two"></router-link>-->
            &nbsp;<router-link to="/show"> <a><img src="../assets/images/buy1.gif" /></a></router-link>&nbsp; &nbsp; &nbsp; <span><a v-on:click="order()"><img src="../assets/images/buy2.gif" /></a></span>
          </td>
        </tr>
      </table>
...
<script>
    ...
    export default {
        ...
        methods: {
            greed(res, id) {
                axios.post(this.url + '/auth/greed', {
                    number: res,
            ...
            checkboxa : function(){
                var _this=this//单选或者多选商品
                var arr=$("input[name='bb']:checked")
                // console.log(arr)
                var new_arr=[]
                ...
                // console.log(new_arr)
                axios.post(this.url+"/auth/price",{
                    token: localStorage.getItem("token"),
                    arr:new_arr
                })
                    .then(function (response) {
                        _this.all_price=response.data
                    })
