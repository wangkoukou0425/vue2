      ...
      <div class="m_left">
        ...
        <div class="left_m">
          ...
          <ul>
            ...
            <li> <router-link :to="{path:  '/Member_Address'}">收货地址</router-link></li>
            <li><a href="#">缺货登记</a></li>
            <li><a href="#">跟踪订单</a></li>
          </ul>
        </div>
      ...
      <div class="m_right">
        ...
        <table border="0" class="mon_tab" style="width:870px; margin-bottom:20px;" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="60%">邀请人：<span style="color:#555555;"></span></td>
          </tr>
          <tr>
...
<script>
    export default {
        ...
        mounted(){
                axios.post('http://localhost/laravel/blog/public/api/auth/me', {
